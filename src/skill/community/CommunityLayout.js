...
const dummyChatRooms = [
    {
        ...
        messages: [
            ...
            { id: 2, senderId: 'user2', senderName: '민이(창작자)', content: '안녕하세요, 후원자님!', timestamp: '오전 09:01' },
            { id: 3, senderId: 'user1', senderName: '나', content: '프로젝트 최종 작업물 잘 받았습니다!', timestamp: '오전 10:00' },
            { id: 4, senderId: 'user2', senderName: '민이(창작자)', content: '확인 감사합니다! 혹시 필요하신 부분 있으실까요?', timestamp: '오전 10:01' },
            { id: 5, senderId: 'user1', senderName: '나', content: '아니요, 완벽합니다! 정말 감사합니다!', timestamp: '오전 10:05' },
            { id: 6, senderId: 'user2', senderName: '민이(창작자)', content: '[문의를 종료합니다.]', timestamp: '19:58' },
        ],
        projectInfo: {
            remainingTime: '제한 없음',
